...
# 
# 
# tcga_breast_cancer_projects <- projects[projects$project == "TCGA" & grepl("breast|BRCA", projects$project_info), ]
# 
# print(tcga_breast_cancer_projects)
# human_projects <- available_projects() # load all human projects
# 
# human_source <- human_projects %>% filter(file_source == 'tcga')
# 
# 
# project <- human_source %>% filter(project == 'BRCA')
# 
